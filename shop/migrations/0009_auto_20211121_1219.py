    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_2', models.ImageField(upload_to='products', verbose_name='عکس دوم کالا')),
                ...
                ('last_price', models.IntegerField(verbose_name='قیمت نهایی کالا با تخفیف')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.category', verbose_name='دسته ی کالا')),
            ],
        ),
        migrations.AddField(
            model_name='myshop',
            name='seller_info',
            field=models.CharField(default=1, max_length=150, verbose_name='مشتری از کجا محصول شما رو خریداری کند؟(برای تمام محصولات اعمال میشود)'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='myshop',
            name='time_end',
            field=models.DateTimeField(blank=True, default=shop.models.one_month_from_today, verbose_name='زمان پایان اشتراک'),
        ),
        migrations.CreateModel(
            name='wishlist',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.product', verbose_name='نام محصول')),
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.myshop', verbose_name='نام فروشگاه')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('stars', models.CharField(default=0, max_length=5)),
                ('stars_left', models.CharField(blank=True, max_length=5)),
                ('feedbacker', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='ارسال کننده ی نظر')),
                ('products', models.ManyToManyField(blank=True, to='shop.Product', verbose_name='کالا')),
            ],
        ),
        migrations.AddField(
            model_name='myshop',
