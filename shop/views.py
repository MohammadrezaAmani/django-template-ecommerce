...
from blog.forms import Updateshop, ShopCreateForm, ShopComment, Comment_shop, ProductCreateForm, Updateproduct, CommentForm, Wishlist, UserUpdateForm, postform,wishliststatus
from .models import myshop, CustomUser, Product, pakage_shop, Comment, wishlist, Category, Order, SupCategory, postinfo
