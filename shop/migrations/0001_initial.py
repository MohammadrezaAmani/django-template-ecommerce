    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "head_title",
                    models.CharField(max_length=100, verbose_name="عنوان سر تیتر"),
                ),
                (
                    "head_description",
                    models.CharField(max_length=80, verbose_name="توضیحات سر تیتر"),
                ),
                ...
                (
                    "image_head1",
                    models.ImageField(
                        upload_to="shops.head", verbose_name="عکس تیتر اول"
                    ),
                ),
                (
                    "image_head2",
                    models.ImageField(
                        upload_to="shops.head", verbose_name="عکس تیتر دوم"
                    ),
                ),
                (
                    "image_head3",
                    models.ImageField(
                        upload_to="shops.head", verbose_name="عکس تیتر سوم"
                    ),
                ),
                (
                    "slug",
                    models.SlugField(unique=True, verbose_name="آیدی فروشگاه شما"),
                ),
                ...
                (
                    "why_us1",
                    models.CharField(max_length=50, verbose_name="عنوان اول چرا ما"),
                ),
                (
                    "why_us_d1",
                    models.CharField(max_length=50, verbose_name="محتوا اول چرا ما"),
                ),
                (
                    "why_us2",
                    models.CharField(max_length=50, verbose_name="عنوان دوم چرا ما"),
                ),
                (
                    "why_us_d2",
                    models.CharField(max_length=50, verbose_name="محتوا دوم چرا ما"),
                ),
                (
                    "why_us3",
                    models.CharField(max_length=50, verbose_name="عنوان سوم چرا ما"),
                ),
                (
                    "why_us_d3",
                    models.CharField(max_length=50, verbose_name="محتوا سوم چرا ما"),
                ),
                (
                    "image_banner1",
                    models.ImageField(
                ...
                (
                    "h_index",
                    models.IntegerField(default=0, verbose_name="رتبه ی فروشگاه"),
                ),
                ("why_us", models.TextField(verbose_name="چرا ما؟")),
                (
                    "grade",
                    models.PositiveIntegerField(
                        default=0, verbose_name="رتبه بر اساس نظرات"
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        verbose_name="زمان ساخت فروشگاه",
                    ),
                ),
