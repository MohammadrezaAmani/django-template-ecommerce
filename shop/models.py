...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE,verbose_name='دسته ی کالا')
...
class myshop(models.Model):
    ...
    time_end = models.DateTimeField(default=one_month_from_today, blank=True,verbose_name='زمان پایان اشتراک')
...
class Comment(models.Model):
    feedbacker = models.ForeignKey(CustomUser, on_delete=models.CASCADE, blank=True, null=True,verbose_name='ارسال کننده ی نظر')
...
class Comment_shop(models.Model):
    feedbacker = models.ForeignKey(CustomUser, on_delete=models.CASCADE, blank=True, null=True,verbose_name='نظر دهنده')
    content = models.TextField(verbose_name='محتوای کامنت')
